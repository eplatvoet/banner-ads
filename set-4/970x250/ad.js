...
$(document).ready(function () {
  gsap.set('.logo', { x: -100, opacity: 0, y:100 });
  gsap.set('.cta', { x: 100, opacity: 0 });
  ...
  function parallaxAnimate() {
    ...
    gsap.to('.logo', { x: -100 + 125 * progress, opacity: progress, duration: 0.2, overwrite: 'auto' });
    gsap.to('.cta', { x: 970 - 400 * progress, opacity: progress, duration: 0.2, overwrite: 'auto' });
