...
$(document).ready(function () {
  gsap.set('.logo', { x: -300, opacity: 0, y:10 });
  ...
  function parallaxAnimate() {
    ...
    gsap.to('.logo', { x: -300 + 305 * progress, opacity: progress, duration: 0.2, overwrite: 'auto' });
    gsap.to('.cta', { x: 300 - 100 * progress, opacity: progress, duration: 0.2, overwrite: 'auto' });
