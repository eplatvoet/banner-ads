...
$(document).ready(function () {
  gsap.set('.logo', { x: -100, opacity: 0, y:3 });
  gsap.set('.cta', { x: 320, opacity: 0 });
  ...
  function parallaxAnimate() {
    ...
    gsap.to('.logo', { x: -100 + 110 * progress, opacity: progress, duration: 0.2, overwrite: 'auto' });
    gsap.to('.cta', { x: 320 - 100 * progress, opacity: progress, duration: 0.2, overwrite: 'auto' });
