...
$(document).ready(function () {
  gsap.set('.logo', { x: -100, opacity: 0, y:50 });
  ...
  function parallaxAnimate() {
    ...
    gsap.to('.logo', { x: -100 + 100 * progress, opacity: progress, duration: 0.2, overwrite: 'auto' });
    gsap.to('.cta', { x: 100 - 100 * progress, opacity: progress, duration: 0.2, overwrite: 'auto' });
