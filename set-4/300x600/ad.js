...
$(document).ready(function () {
  gsap.set('.logo', { x: -300, opacity: 0, y:50 });
  gsap.set('.cta', { x: 300, opacity: 0 });
  ...
  function parallaxAnimate() {
    ...
    gsap.to('.logo', { x: -300 + 348 * progress, opacity: progress, duration: 0.2, overwrite: 'auto' });
    gsap.to('.cta', { x: 300 - 246 * progress, opacity: progress, duration: 0.2, overwrite: 'auto' });
